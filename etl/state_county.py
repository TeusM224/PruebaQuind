...
path_load = '/content/drive/MyDrive/pruebaQuind/data/processed/filtered_meta.csv'
#'/content/drive/MyDrive/pruebaQuind/data/raw/metadata-sitios/1.json' -> Por si se elige uno por uno
...
geolocator = Nominatim(user_agent="location_beta")
...
f = i+1000
b = True
path_save = '/content/drive/MyDrive/pruebaQuind/data/processed/location.csv'#aca la ruta donde se guarda el nuevo archivo
while b :
  if f > n_rows :
    f = n_rows
    b= False
